...
namespace efanna {
  ...
  typedef void (*BuildProgressCallback)(void* context, size_t completed, size_t total);
  struct IndexParams{
    ...
    BuildProgressCallback build_progress_callback = nullptr;
    void* build_progress_context = nullptr;
  };
